...
Log_Folder = "\\rodrimar.com.br\TI\AD-MGT\LOGS\Log_Script_exe-sistemas\Log_Script_metaframeShorcut"
...
For Each objFile in colFiles
	...
	if ( inStr(LCase(objFile.Name),".url") <> 0 ) Then
		...
		if ( inStr(LCase(strFileContent), "metaframe" ) <> 0 ) Then
			...
			strFileContentEdited = objRegEx.Replace( strFileContent, "http://citrix.rodrimar.com.br" )
